...
//  Block Boogie
//
//  Created by Patrick Sweeney on 7/14/16.
...
class level16: SKScene, SKPhysicsContactDelegate
{
    ...
    func endOfLevel()
    {
        ...
        let levelbool = true
        UserDefaults.standard.set(levelbool, forKey:"level16")
        UserDefaults.standard.synchronize()
        
        if(collectibleFound == true)
        {
            UserDefaults.standard.set(levelbool, forKey:"block16")
            UserDefaults.standard.synchronize()
        }
    }
    func goBackToHub()
    ...
    func deathAnimation(_ playerVelocity: CGVector, playerPosition: CGPoint)
    {
        ...
        block1.color = UIColor(red:0.2, green:0.40, blue:1.00, alpha:1.0)
        ...
        block2.color = UIColor(red:0.2, green:0.40, blue:1.00, alpha:1.0)
        ...
        block3.color = UIColor(red:0.2, green:0.40, blue:1.00, alpha:1.0)
        ...
        block4.color = UIColor(red:0.2, green:0.40, blue:1.00, alpha:1.0)
