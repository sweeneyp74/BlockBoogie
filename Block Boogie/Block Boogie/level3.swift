...
//  Block Boogie
//
//  Created by Patrick Sweeney on 5/26/16.
...
class level3: SKScene, SKPhysicsContactDelegate
{
    ...
    let redblockmove: SKAction = SKAction.moveByX(0, y: 400, duration: 0.5)
    let redblockmove2: SKAction = SKAction.moveByX(800, y: 0, duration: 1)
    //------------------------------------------------
    override func didMoveToView(view: SKView)
    {
        ...
        {
            CheckPoint = cp
            CheckPoint.CheckPointPosition = CGPointMake(CheckPoint.position.x, CheckPoint.position.y + 200)
        ...
        if let someRedBlock:SKSpriteNode = self.childNodeWithName("redblock14") as? SKSpriteNode
        {
            ...
            redBlock14.runAction(SKAction.repeatActionForever(SKAction.sequence([SKAction.moveByX(0, y: -100, duration: 3), SKAction.moveByX(0, y: 100, duration: 0.5)])))
        ...
        if let someRedBlock:SKSpriteNode = self.childNodeWithName("redblock15") as? SKSpriteNode
        {
            ...
            redBlock15.runAction(SKAction.repeatActionForever(SKAction.sequence([SKAction.moveByX(0, y: -100, duration: 2), SKAction.moveByX(0, y: 100, duration: 0.5)])))
        ...
        if let someRedBlock:SKSpriteNode = self.childNodeWithName("redblock16") as? SKSpriteNode
        {
            ...
            redBlock16.runAction(SKAction.repeatActionForever(SKAction.sequence([SKAction.moveByX(0, y: -100, duration: 1), SKAction.moveByX(0, y: 100, duration: 0.5)])))
        }
        if let someRedBlock:SKSpriteNode = self.childNodeWithName("redblock17") as? SKSpriteNode
        {
            ...
            redBlock17.runAction(SKAction.repeatActionForever(SKAction.sequence([SKAction.moveByX(0, y: 150, duration: 1), SKAction.moveByX(0, y: -150, duration: 2)])))
        ...
        if let someRedBlock:SKSpriteNode = self.childNodeWithName("redblock18") as? SKSpriteNode
        {
            ...
            redBlock18.runAction(SKAction.repeatActionForever(SKAction.sequence([SKAction.moveByX(0, y: 150, duration: 1), SKAction.moveByX(0, y: -150, duration: 2)])))
        ...
        if let someRedBlock:SKSpriteNode = self.childNodeWithName("redblock19") as? SKSpriteNode
        {
            ...
            redBlock19.runAction(SKAction.repeatActionForever(SKAction.sequence([SKAction.moveByX(0, y: 150, duration: 1), SKAction.moveByX(0, y: -150, duration: 2)])))
        }
        if let someRedBlock:SKSpriteNode = self.childNodeWithName("redblock20") as? SKSpriteNode
        {
            ...
            redBlock20.runAction(SKAction.repeatActionForever(SKAction.sequence([SKAction.moveByX(0, y: -150, duration: 1), SKAction.moveByX(0, y: 150, duration: 2)])))
        ...
        if let someRedBlock:SKSpriteNode = self.childNodeWithName("redblock21") as? SKSpriteNode
        {
            ...
            redBlock21.runAction(SKAction.repeatActionForever(SKAction.sequence([SKAction.moveByX(0, y: -150, duration: 1), SKAction.moveByX(0, y: 150, duration: 2)])))
        }
        if let someRedBlock:SKSpriteNode = self.childNodeWithName("redblock22") as? SKSpriteNode
        {
            ...
            redBlock22.runAction(SKAction.repeatActionForever(SKAction.sequence([SKAction.moveByX(-100, y: 0, duration: 2), SKAction.moveByX(100, y: 0, duration: 0.5)])))
    ...
    func endOfLevel()
    {
        let move: SKAction = SKAction.moveByX(0, y: -1000, duration: NSTimeInterval(2))
        ...
        let levelbool = true
        NSUserDefaults.standardUserDefaults().setObject(levelbool, forKey:"level3")
        NSUserDefaults.standardUserDefaults().synchronize()

        if(collectibleFound == true)
        {
            NSUserDefaults.standardUserDefaults().setObject(levelbool, forKey:"block3")
            NSUserDefaults.standardUserDefaults().synchronize()
        }
    }
    func goBackToHub()
    ...
    func moveCheckPoint()
    {
        if(isCheckPointActive == false)
        {
            ...
            let movecp: SKAction = SKAction.moveByX(0, y: 150, duration: 1)
