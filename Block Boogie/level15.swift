...
//  Block Boogie
//
//  Created by Patrick Sweeney on 7/1/16.
...
class level15: SKScene, SKPhysicsContactDelegate
{
    ...
    func endOfLevel()
    {
        ...
        let levelbool = true
        UserDefaults.standard.set(levelbool, forKey:"level15")
        UserDefaults.standard.synchronize()
        
        if(collectibleFound == true)
        {
            UserDefaults.standard.set(levelbool, forKey:"block15")
            UserDefaults.standard.synchronize()
        }
